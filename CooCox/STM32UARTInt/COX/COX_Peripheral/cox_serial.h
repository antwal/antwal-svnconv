...
typedef enum {
  ...
  COX_SERIAL_INT_CONF	   = 4,  /*!< Interrupt Configuration */
...
/** Serial Interupt Configuration */
typedef enum {
	RXNE_ENABLE = 0,			 /* !< Receiver Interrupt Enable */
	TXE_ENABLE = 1,				 /* !< Transmitter Interrupt Enable */
}SERIAL_INT_ENABLE_Def;
