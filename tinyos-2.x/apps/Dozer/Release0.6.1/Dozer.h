...
enum {
  ...
  DEFAULT_BEACON_INTERVAL = 61440U,	// 122880U, //61440U,//,30720U
  ...
  // Suspend Mode Beacon Listening Interval
  SUSPENDED_LISTEN_PERIOD = 122880U,	
...
typedef nx_struct dozer_beacon {
  nxle_uint16_t	parent;			// Parent Note Id 
  nxle_uint8_t	children;		// Number of children connected to the node
  nxle_uint8_t	hopcount;		// The depth of node in the tree
  nxle_uint16_t	seed;			// Seed for Random number generation used as jitter 
  nx_uint8_t (COUNT(0) data)[0];        // Deputy place-holder, field for Dissemination of Control Data
//} dozer_beacon_t;
