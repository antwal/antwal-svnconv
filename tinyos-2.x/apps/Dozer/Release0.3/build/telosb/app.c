...
enum __nesc_unnamed4262 {
  ...
  DATA_QUEUE_SIZE = 25, 
  MAX_CONSECUTIVE_MISSED_BEACONS = 5, 
...
typedef nx_struct dozer_beacon {
  nxle_uint8_t children;
  nxle_uint8_t hopcount;
  nxle_uint16_t seed;
} __attribute__((packed)) 
__attribute((packed))  dozer_beacon_t;
...
typedef nx_struct dozer_conn_req {
  nxle_uint16_t parent_id;
} __attribute__((packed)) dozer_conn_req_t;
...
typedef nx_struct dozer_conn_rep {
  nxle_uint8_t tdma_slot;
} __attribute__((packed)) dozer_conn_rep_t;
...
__attribute((packed))  dozer_msg_t;
# 34 "qsort.h"
struct SortEntry {
  uint16_t id;
  uint8_t receiveEst;
...
static int cmp(const void *arg_0x405c11e0, const void *arg_0x405c1378);
static char *med3(char *arg_0x405c1808, char *arg_0x405c1980, char *arg_0x405c1af8);
static void swapfunc(char *arg_0x405bf010, char *arg_0x405bf188, int arg_0x405bf2e0);
...
enum AMQueueP$__nesc_unnamed4301 {
...
# 51 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Init.nc"
static error_t SchedulerP$Init$init(void );
# 13 "TDMASchedule.nc"
static error_t SchedulerP$TDMASchedule$clearTableEntry(uint16_t node_id, uint8_t parent);
#line 7
static error_t SchedulerP$TDMASchedule$getPPB(dozer_parent_t **gparent);
...
#line 5
static error_t SchedulerP$TDMASchedule$setPPB(uint8_t *Index, dozer_parent_t *ppb, uint8_t count);
...
static error_t SchedulerP$TDMASchedule$setParentTimeStamp(uint16_t node_id, dozer_beacon_t *bmsg, uint32_t timestamp);
#line 9
static error_t SchedulerP$TDMASchedule$startTimers(void );
#line 21
static uint8_t SchedulerP$TDMASchedule$allocChildTimeSlot(uint16_t node_id, dozer_beacon_t *local);
# 72 "/opt/CVSTinyOS/tinyos-2.x/tos/lib/timer/Timer.nc"
...
static void TreeP$ConnReqListenTimer$stop(void );
# 51 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Init.nc"
static error_t TreeP$SchedulerInit$init(void );
# 62 "/opt/CVSTinyOS/tinyos-2.x/tos/lib/timer/Timer.nc"
...
static void TreeP$BeaconTimer$stop(void );
#line 62
...
#line 7
static error_t TreeP$TDMASchedule$getPPB(dozer_parent_t **gparent);
...
#line 5
static error_t TreeP$TDMASchedule$setPPB(uint8_t *Index, dozer_parent_t *ppb, uint8_t count);
...
static error_t TreeP$TDMASchedule$setParentTimeStamp(uint16_t node_id, dozer_beacon_t *bmsg, uint32_t timestamp);
#line 9
static error_t TreeP$TDMASchedule$startTimers(void );
#line 21
static uint8_t TreeP$TDMASchedule$allocChildTimeSlot(uint16_t node_id, dozer_beacon_t *local);
# 50 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Leds.nc"
...
uint16_t TreeP$listen_id = 0xFF;
uint16_t TreeP$child_id;

bool TreeP$radioOn = FALSE;
#line 61
bool TreeP$sendBusy = FALSE;
bool TreeP$ParentOn = FALSE;
#line 62
bool TreeP$ChildOn = FALSE;
...
static error_t TreeP$chooseParent(void );
#line 386
static inline void TreeP$replaceEntry(uint16_t src, dozer_beacon_t beacon, uint32_t time_stamp);
#line 406
static inline void TreeP$updateNgbrs(uint16_t src, dozer_beacon_t beacon, uint32_t time_stamp);
#line 456
...
# 19 "SchedulerP.nc"
static error_t SchedulerP$chooseParent(void );
# 118 "/opt/CVSTinyOS/tinyos-2.x/tos/lib/timer/Timer.nc"
...
# 50 "/opt/CVSTinyOS/tinyos-2.x/tos/lib/timer/LocalTime.nc"
static uint32_t SchedulerP$LocalTime$get(void );
# 118 "/opt/CVSTinyOS/tinyos-2.x/tos/lib/timer/Timer.nc"
...
static void SchedulerP$Leds$led1Toggle(void );
# 118 "/opt/CVSTinyOS/tinyos-2.x/tos/lib/timer/Timer.nc"
...
static inline error_t SchedulerP$Init$init(void );
#line 59
static inline error_t SchedulerP$TDMASchedule$setPPB(uint8_t *Index, dozer_parent_t *ppb, uint8_t count);
#line 90
static inline error_t SchedulerP$TDMASchedule$getPPB(dozer_parent_t **gParent);
#line 179
static error_t SchedulerP$TDMASchedule$clearTableEntry(uint16_t node_id, uint8_t parent);
#line 244
...
static inline uint8_t SchedulerP$TDMASchedule$allocChildTimeSlot(uint16_t node_id, dozer_beacon_t *local);
...
# 28 "/opt/CVSTinyOS/tinyos-2.x/tos/chips/msp430/timer/Msp430TimerEvent.nc"
inline static void /*Msp430TimerC.Msp430TimerA*/Msp430TimerP$0$Event$fired(uint8_t arg_0x406494f0){
#line 28
  switch (arg_0x406494f0) {
#line 28
    case 0:
#line 28
...
#line 28
    default:
#line 28
      /*Msp430TimerC.Msp430TimerA*/Msp430TimerP$0$Event$default$fired(arg_0x406494f0);
#line 28
      break;
#line 28
    }
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerA0*/Msp430TimerCapComP$0$__nesc_unnamed4345 {
#line 47
    uint16_t f;
#line 47
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerA1*/Msp430TimerCapComP$1$__nesc_unnamed4346 {
#line 47
    uint16_t f;
#line 47
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerA2*/Msp430TimerCapComP$2$__nesc_unnamed4347 {
#line 47
    uint16_t f;
#line 47
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerB0*/Msp430TimerCapComP$3$__nesc_unnamed4348 {
#line 47
    uint16_t f;
#line 47
...
# 118 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Resource.nc"
inline static bool /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$isOwner(uint8_t arg_0x40c16718){
#line 118
  unsigned char __nesc_result;
#line 118

#line 118
  switch (arg_0x40c16718) {
#line 118
...
#line 118
    default:
#line 118
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$default$isOwner(arg_0x40c16718);
#line 118
      break;
#line 118
    }
...
# 39 "/opt/CVSTinyOS/tinyos-2.x/tos/chips/msp430/usart/Msp430SpiConfigure.nc"
inline static msp430_spi_union_config_t */*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$Msp430SpiConfigure$getConfig(uint8_t arg_0x40c151b8){
#line 39
  union __nesc_unnamed4283 *__nesc_result;
#line 39

#line 39
    __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$Msp430SpiConfigure$default$getConfig(arg_0x40c151b8);
#line 39
...
# 49 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceConfigure$configure(uint8_t arg_0x40d1b510){
#line 49
  switch (arg_0x40d1b510) {
#line 49
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceConfigure$default$configure(arg_0x40d1b510);
#line 49
      break;
#line 49
    }
...
# 51 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceRequested$immediateRequested(uint8_t arg_0x40d1c108){
#line 51
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceRequested$default$immediateRequested(arg_0x40d1c108);
#line 51
}
#line 51
...
# 87 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$immediateRequest(uint8_t arg_0x40c16718){
#line 87
  unsigned char __nesc_result;
#line 87
...
#line 87
    default:
#line 87
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$default$immediateRequest(arg_0x40c16718);
#line 87
      break;
#line 87
    }
...
# 43 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceRequested$requested(uint8_t arg_0x40d1c108){
#line 43
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceRequested$default$requested(arg_0x40d1c108);
#line 43
}
#line 43
...
# 78 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$request(uint8_t arg_0x40c16718){
#line 78
  unsigned char __nesc_result;
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$default$request(arg_0x40c16718);
#line 78
      break;
#line 78
    }
...
# 55 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceConfigure$unconfigure(uint8_t arg_0x40d1b510){
#line 55
  switch (arg_0x40d1b510) {
#line 55
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C$0$CLIENT_ID:
...
#line 55
    default:
#line 55
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceConfigure$default$unconfigure(arg_0x40d1b510);
#line 55
      break;
#line 55
    }
...
# 110 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$release(uint8_t arg_0x40c16718){
#line 110
  unsigned char __nesc_result;
#line 110
...
#line 110
    default:
#line 110
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$default$release(arg_0x40c16718);
#line 110
      break;
#line 110
    }
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerB1*/Msp430TimerCapComP$4$__nesc_unnamed4350 {
#line 47
    uint16_t f;
#line 47
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerB3*/Msp430TimerCapComP$6$__nesc_unnamed4352 {
#line 47
    uint16_t f;
#line 47
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerB4*/Msp430TimerCapComP$7$__nesc_unnamed4353 {
#line 47
    uint16_t f;
#line 47
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerB5*/Msp430TimerCapComP$8$__nesc_unnamed4354 {
#line 47
    uint16_t f;
#line 47
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerB6*/Msp430TimerCapComP$9$__nesc_unnamed4355 {
#line 47
    uint16_t f;
#line 47
...
# 89 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x410257a8, message_t * msg, error_t error){
#line 89
  switch (arg_0x410257a8) {
#line 89
    case 0U:
#line 89
...
#line 89
    default:
#line 89
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x410257a8, msg, error);
#line 89
      break;
#line 89
    }
...
#line 56
# 69 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x410231b8, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = CC2420ActiveMessageP$AMSend$send(arg_0x410231b8, addr, msg, len);
#line 69
...
# 59 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/SendNotifier.nc"
inline static void CC2420ActiveMessageP$SendNotifier$aboutToSend(am_id_t arg_0x407dcb78, am_addr_t dest, message_t * msg){
#line 59
    CC2420ActiveMessageP$SendNotifier$default$aboutToSend(arg_0x407dcb78, dest, msg);
#line 59
}
#line 59
...
# 95 "/opt/CVSTinyOS/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP$RadioBackoff$requestCca(am_id_t arg_0x407f5230, message_t * msg){
#line 95
    CC2420ActiveMessageP$RadioBackoff$default$requestCca(arg_0x407f5230, msg);
#line 95
}
#line 95
...
#line 50
# 15 "TDMASchedule.nc"
inline static error_t TreeP$TDMASchedule$setParentTimeStamp(uint16_t node_id, dozer_beacon_t *bmsg, uint32_t timestamp){
#line 15
  unsigned char __nesc_result;
#line 15

#line 15
  __nesc_result = SchedulerP$TDMASchedule$setParentTimeStamp(node_id, bmsg, timestamp);
#line 15
...
#line 274
    TreeP$TDMASchedule$setParentTimeStamp(TreeP$listen_id, (void *)0, TreeP$LocalTime$get());
    }
}
...
#line 61
  ...
  if (SchedulerP$gParentNode.flag != INVALID_VALUE) {
      for (i = 0, j = 1; i < count; i++, j++) {
          if (ppb[Index[i]].parent_id == SchedulerP$gParentNode.parent_id) {
              SchedulerP$ParentNodes[0] = &ppb[Index[i]];
            }
          else 
#line 67
            {
              SchedulerP$ParentNodes[j] = &ppb[Index[i]];
              SchedulerP$ParentNodes[j]->rounds = PARENTS_UPDATE_INTERVAL / DEFAULT_BEACON_INTERVAL;
            }
        }
      ...
      for (i = 0; i < count; i++) {
          SchedulerP$ParentNodes[i] = &ppb[Index[i]];
          SchedulerP$ParentNodes[i]->rounds = PARENTS_UPDATE_INTERVAL / DEFAULT_BEACON_INTERVAL;
        }
    }

  SchedulerP$ParentNodes[0]->rounds = 1;
  for (; i < MAX_POTENTIAL_PARENTS; i++) 
    SchedulerP$ParentNodes[i] = (void *)0;

  SchedulerP$TDMASchedule$startTimers();
  return SUCCESS;
}

# 5 "TDMASchedule.nc"
inline static error_t TreeP$TDMASchedule$setPPB(uint8_t *Index, dozer_parent_t *ppb, uint8_t count){
#line 5
  unsigned char __nesc_result;
#line 5

#line 5
  __nesc_result = SchedulerP$TDMASchedule$setPPB(Index, ppb, count);
#line 5
...
#line 242
  ...
  for (j = 0, i = NBR_TABLE_SIZE; i != 0 && j < MAX_POTENTIAL_PARENTS; i--) {
      if (TreeP$nbrTable[i - 1].flag != INVALID_VALUE) {
          TreeP$index[j++] = i - 1;
        }
    }


  TreeP$TDMASchedule$setPPB(TreeP$index, TreeP$nbrTable, j);
...
#line 379
    {
      if (SchedulerP$DataListen) {
          SchedulerP$DataListen = FALSE;
          SchedulerP$TDMASchedule$radioWakeup(TSLOT_LISTEN_STOP, __nesc_ntoh_leuint16(SchedulerP$ChildNodes[SchedulerP$gChildTSlot - 1].child_id.data));
        }
...
#line 387
      if (__nesc_ntoh_leuint16(SchedulerP$ChildNodes[SchedulerP$gChildTSlot].child_id.data) != INVALID_VALUE) {
          SchedulerP$DataListen = TRUE;
          SchedulerP$TDMASchedule$radioWakeup(TSLOT_LISTEN, __nesc_ntoh_leuint16(SchedulerP$ChildNodes[SchedulerP$gChildTSlot].child_id.data));
        }
    }
#line 391
    __nesc_atomic_end(__nesc_atomic); }
...
# 72 "/opt/CVSTinyOS/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x40f54068){
#line 72
  switch (arg_0x40f54068) {
#line 72
    case 1U:
#line 72
...
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x40f54068);
#line 72
      break;
#line 72
    }
...
# 67 "/opt/CVSTinyOS/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void TreeP$BeaconTimer$stop(void ){
#line 67
...
#line 53
# 50 "/opt/CVSTinyOS/tinyos-2.x/tos/lib/timer/LocalTime.nc"
inline static uint32_t SchedulerP$LocalTime$get(void ){
#line 50
  unsigned long __nesc_result;
#line 50
...
#line 94
  ...
  if (
#line 97
  SchedulerP$gParentNode.flag != INVALID_VALUE && __nesc_ntoh_leuint8(
  SchedulerP$gParentNode.beacon.hopcount.data) != 0 && 
  SchedulerP$gParentNode.retries == MAX_RETRIES) {
      SchedulerP$gParentNode.flag = INVALID_VALUE;
    }

  for (i = 0; i < MAX_POTENTIAL_PARENTS && SchedulerP$ParentNodes[i] != (void *)0; i++) {
      if (SchedulerP$ParentNodes[i]->flag == INVALID_VALUE) {
          continue;
        }

      if (__nesc_ntoh_leuint8(SchedulerP$ParentNodes[i]->beacon.hopcount.data) == 0) {
          Index = i;
          break;
        }

      if (__nesc_ntoh_leuint8(SchedulerP$ParentNodes[Index]->beacon.hopcount.data) == __nesc_ntoh_leuint8(SchedulerP$ParentNodes[i]->beacon.hopcount.data)) 
        {
          if (SchedulerP$ParentNodes[Index]->retries == SchedulerP$ParentNodes[i]->retries) 
            {
              if (__nesc_ntoh_leuint8(SchedulerP$ParentNodes[Index]->beacon.children.data) <= __nesc_ntoh_leuint8(SchedulerP$ParentNodes[i]->beacon.children.data)) {
                  Index = Index;
                }
              else 
#line 119
...
#line 129
  ...
  *gParent = SchedulerP$ParentNodes[Index];
  if (SchedulerP$ParentNodes[Index]->flag == INVALID_VALUE) {
#line 136
      return FAIL;
    }
#line 137
  SchedulerP$ParentNodes[Index]->retries++;
  memcpy(&SchedulerP$gParentNode, SchedulerP$ParentNodes[Index], sizeof(dozer_parent_t ));

  rounds = (SchedulerP$LocalTime$get() - SchedulerP$ParentNodes[Index]->timestamp) / DEFAULT_BEACON_INTERVAL + 1;
  rounds += SchedulerP$ParentNodes[Index]->missed * SchedulerP$ParentNodes[Index]->rounds;
  SchedulerP$ParentNodes[Index]->rounds = rounds;
  SchedulerP$ParentNodes[Index]->missed = 0;
  tmp = rounds;

  seed_val = __nesc_ntoh_leuint16(SchedulerP$ParentNodes[Index]->beacon.seed.data);
...
# 7 "TDMASchedule.nc"
inline static error_t TreeP$TDMASchedule$getPPB(dozer_parent_t **gparent){
#line 7
  unsigned char __nesc_result;
#line 7

#line 7
  __nesc_result = SchedulerP$TDMASchedule$getPPB(gparent);
#line 7
...
#line 67
# 72 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Leds.nc"
inline static void SchedulerP$Leds$led1Toggle(void ){
#line 72
  LedsP$Leds$led1Toggle();
#line 72
}
#line 72
# 19 "SchedulerP.nc"
inline static error_t SchedulerP$chooseParent(void ){
#line 19
  unsigned char __nesc_result;
#line 19
...
# 67 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * CC2420TinyosNetworkP$NonTinyosReceive$receive(uint8_t arg_0x40fdabb8, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = CC2420TinyosNetworkP$NonTinyosReceive$default$receive(arg_0x40fdabb8, msg, payload, len);
#line 67
...
# 67 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP$Snoop$receive(am_id_t arg_0x407de148, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = CC2420ActiveMessageP$Snoop$default$receive(arg_0x407de148, msg, payload, len);
#line 67
...
#line 67
inline static void TreeP$ConnReqListenTimer$stop(void ){
#line 67
...
#line 390
    {
      for (i = 0; i < NBR_TABLE_SIZE; i++) {
          ...
          if (
#line 392
          TreeP$nbrTable[i].parent_id != TreeP$gParent_id
           && __nesc_ntoh_leuint8(TreeP$nbrTable[Index].beacon.hopcount.data) >= __nesc_ntoh_leuint8(TreeP$nbrTable[i].beacon.hopcount.data)
           && TreeP$nbrTable[Index].retries >= TreeP$nbrTable[i].retries) {
              Index = i;
            }
        }
    }
#line 398
    __nesc_atomic_end(__nesc_atomic); }
  TreeP$nbrTable[Index].flag = 1;
  TreeP$nbrTable[Index].parent_id = src;
  TreeP$nbrTable[Index].missed = 0;
  TreeP$nbrTable[Index].timestamp = time_stamp;
...
static inline void TreeP$updateNgbrs(uint16_t src, dozer_beacon_t beacon, uint32_t time_stamp)
{
  uint8_t i;
#line 408
  uint8_t tableUpdated = 0;



  for (i = 0; i < NBR_TABLE_SIZE; i++) {

      if (TreeP$nbrTable[i].parent_id == src) {
          tableUpdated = 1;
          if (TreeP$nbrTable[i].flag == 1) {
              TreeP$nbrTable[i].missed = 0;
              TreeP$nbrTable[i].timestamp = time_stamp;
  ...
  if (!tableUpdated) {
      ...
      quick_sort(TreeP$nbrTable, INV, sizeof(dozer_parent_t ));

      if (TreeP$nbrTable[0].flag == INVALID_VALUE) {
          TreeP$nbrTable[0].flag = 1;
          TreeP$nbrTable[0].parent_id = src;
          TreeP$nbrTable[0].missed = 0;
          TreeP$nbrTable[0].timestamp = time_stamp;
          TreeP$nbrTable[0].retries = 0;
          tableUpdated = 1;
          memcpy(& TreeP$nbrTable[0].beacon, &beacon, sizeof beacon);
        }
    }


  if (!tableUpdated) {
      TreeP$replaceEntry(src, beacon, time_stamp);
    }
}
...
#line 461
  ...
  switch (__nesc_ntoh_leuint8(dmsg->type.data)) {
      case DOZER_BEACON: 
...
#line 470
      ...
      if (TreeP$TreeConnected && !TreeP$NbrUpdatePending) {
          if (src == TreeP$listen_id) {
              TreeP$BeaconWaitTimer$stop();
              TreeP$TDMASchedule$setParentTimeStamp(src, bmsg, TreeP$LocalTime$get());
              TreeP$ChildOn = FALSE;
              TreeP$stop_radio();
            }
        }
...
#line 488
        {
          if (__nesc_ntoh_leuint8(bmsg->children.data) >= MAX_CHILDREN && src != TreeP$gParent_id) {
#line 489
              return msg;
            }
#line 490
          TreeP$updateNgbrs(src, beacon, TreeP$LocalTime$get());
        }
      break;

      case DOZER_CONNREQ: 
        TreeP$ConnReqListenTimer$stop();
...
#line 515
        {
          TreeP$TDMASchedule$setParentTDMASlot(__nesc_ntoh_leuint8(connRep->tdma_slot.data));
          TreeP$TreeConnected = TRUE;
          TreeP$ChildOn = FALSE;
          __nesc_hton_leuint8(TreeP$local.hopcount.data, __nesc_ntoh_leuint8(TreeP$nbrTable[TreeP$gPIndex].beacon.hopcount.data) + 1);


          TreeP$NeighbourUpdateTimer$startOneShot(NBR_UPDATION_PERIOD);
          TreeP$stop_radio();
          TreeP$BeaconTimer$startOneShotAt(TreeP$nbrTable[TreeP$gPIndex].timestamp, (
          CHILD_CONNECTION_PERIOD + MAX_CHILDREN * TDMA_SLOT_LEN + 0x1ff) * (__nesc_ntoh_leuint8(connRep->tdma_slot.data) + 1) + __nesc_ntoh_leuint16(TreeP$local.seed.data));
        }
#line 526
        __nesc_atomic_end(__nesc_atomic); }
...
# 67 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP$Receive$receive(am_id_t arg_0x407dfa60, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x407dfa60) {
#line 67
    case 50UL:
#line 67
...
#line 67
    default:
#line 67
      __nesc_result = CC2420ActiveMessageP$Receive$default$receive(arg_0x407dfa60, msg, payload, len);
#line 67
      break;
#line 67
    }
...
# 92 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$Resource$granted(uint8_t arg_0x40bf28e8){
#line 92
  switch (arg_0x40bf28e8) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C$0$CLIENT_ID:
#line 92
...
#line 92
    default:
#line 92
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$Resource$default$granted(arg_0x40bf28e8);
#line 92
      break;
#line 92
    }
...
# 92 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$Resource$granted(uint8_t arg_0x40d1d6b8){
#line 92
  switch (arg_0x40d1d6b8) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C$0$CLIENT_ID:
#line 92
...
#line 92
    default:
#line 92
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$Resource$default$granted(arg_0x40d1d6b8);
#line 92
      break;
#line 92
    }
...
# 71 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/SpiPacket.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$SpiPacket$sendDone(uint8_t arg_0x40c18ee8, uint8_t * txBuf, uint8_t * rxBuf, uint16_t len, error_t error){
#line 71
  switch (arg_0x40c18ee8) {
#line 71
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C$0$CLIENT_ID:
#line 71
...
#line 71
    default:
#line 71
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$SpiPacket$default$sendDone(arg_0x40c18ee8, txBuf, rxBuf, len, error);
#line 71
      break;
#line 71
    }
...
# 71 "/opt/CVSTinyOS/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP$Fifo$readDone(uint8_t arg_0x40b80280, uint8_t * data, uint8_t length, error_t error){
#line 71
  switch (arg_0x40b80280) {
#line 71
    case CC2420_TXFIFO:
#line 71
...
#line 71
    default:
#line 71
      CC2420SpiP$Fifo$default$readDone(arg_0x40b80280, data, length, error);
#line 71
      break;
#line 71
    }
...
# 91 "/opt/CVSTinyOS/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP$Fifo$writeDone(uint8_t arg_0x40b80280, uint8_t * data, uint8_t length, error_t error){
#line 91
  switch (arg_0x40b80280) {
#line 91
    case CC2420_TXFIFO:
...
#line 91
    default:
#line 91
      CC2420SpiP$Fifo$default$writeDone(arg_0x40b80280, data, length, error);
#line 91
      break;
#line 91
    }
...
# 92 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void CC2420SpiP$Resource$granted(uint8_t arg_0x40b81818){
#line 92
  switch (arg_0x40b81818) {
#line 92
...
#line 92
    default:
#line 92
      CC2420SpiP$Resource$default$granted(arg_0x40b81818);
#line 92
      break;
#line 92
    }
...
# 99 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP$AMSend$sendDone(am_id_t arg_0x407df0a0, message_t * msg, error_t error){
#line 99
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x407df0a0, msg, error);
#line 99
}
#line 99
...
inline static void * /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$getPayload(am_id_t arg_0x410231b8, message_t * msg, uint8_t len){
#line 124
  void *__nesc_result;
#line 124

#line 124
  __nesc_result = CC2420ActiveMessageP$AMSend$getPayload(arg_0x410231b8, msg, len);
#line 124
...
#line 344
{
  ...
  if (TreeP$radioOn && !TreeP$sendBusy) {
      ...
      __nesc_hton_leuint8(dmsg->type.data, DOZER_CONNACK);
...
#line 425
        {
          if (__nesc_ntoh_leuint16(SchedulerP$ChildNodes[i].child_id.data) == node_id) 
            {
              unsigned char __nesc_temp = 
#line 427
              i;
...
#line 432
        {
          if (__nesc_ntoh_leuint16(SchedulerP$ChildNodes[i].child_id.data) == INVALID_VALUE) {
              __nesc_hton_leuint16(SchedulerP$ChildNodes[i].child_id.data, node_id);
              (__nesc_temp47 = local->children.data, __nesc_hton_leuint8(__nesc_temp47, (__nesc_temp48 = __nesc_ntoh_leuint8(__nesc_temp47)) + 1), __nesc_temp48);
              {
                unsigned char __nesc_temp = 
#line 436
                i;
...
# 21 "TDMASchedule.nc"
inline static uint8_t TreeP$TDMASchedule$allocChildTimeSlot(uint16_t node_id, dozer_beacon_t *local){
#line 21
  unsigned char __nesc_result;
#line 21

#line 21
  __nesc_result = SchedulerP$TDMASchedule$allocChildTimeSlot(node_id, local);
#line 21
...
#line 323
{
  ...
  __nesc_hton_leuint8(connRep.tdma_slot.data, TreeP$TDMASchedule$allocChildTimeSlot(TreeP$child_id, &TreeP$local));
  if (__nesc_ntoh_leuint8(connRep.tdma_slot.data) == INVALID_VALUE) {
      TreeP$ParentOn = FALSE;
      TreeP$stop_radio();
      return;
    }
  ...
  if (TreeP$radioOn && !TreeP$sendBusy) {
      dmsg = (dozer_msg_t *)TreeP$BeaconSend$getPayload(&TreeP$sendBuf, sizeof(dozer_msg_t ));
      __nesc_hton_leuint8(dmsg->type.data, DOZER_CONNREP);
...
#line 311
{
  ...
  if (TreeP$radioOn && !TreeP$sendBusy) {
      dmsg = (dozer_msg_t *)TreeP$BeaconSend$getPayload(&TreeP$sendBuf, sizeof(dozer_msg_t ));
      __nesc_hton_leuint8(dmsg->type.data, DOZER_CONNREQ);
      if (TreeP$BeaconSend$send(TreeP$gParent_id, &TreeP$sendBuf, sizeof(dozer_msg_t )) == SUCCESS) {
          TreeP$sendBusy = TRUE;
        }
    }
...
#line 291
{
  ...
  if (TreeP$radioOn && !TreeP$sendBusy) {
      ...
      dmsg = (dozer_msg_t *)TreeP$BeaconSend$getPayload(&TreeP$sendBuf, sizeof(dozer_msg_t ));
      __nesc_hton_leuint8(dmsg->type.data, DOZER_BEACON);


      memcpy(&dmsg->dozer_data[0], &TreeP$local, sizeof TreeP$local);
...
{
  SchedulerP$gParentNode.flag = INVALID_VALUE;
  SchedulerP$gParentNode.missed = 0;
  SchedulerP$gParentNode.parent_id = INVALID_VALUE;
  SchedulerP$gParentNode.timestamp = 0;
  SchedulerP$gParentNode.retries = 0;
  SchedulerP$gParentNode.rounds = INVALID_VALUE;
  memset(& SchedulerP$gParentNode.beacon, 0, sizeof(dozer_beacon_t ));
  __nesc_hton_leuint8(SchedulerP$gParentNode.beacon.hopcount.data, INVALID_VALUE);
  return SUCCESS;
}

# 51 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Init.nc"
inline static error_t TreeP$SchedulerInit$init(void ){
#line 51
  unsigned char __nesc_result;
#line 51

#line 51
  __nesc_result = SchedulerP$Init$init();
#line 51
...
#line 77
{
  ...
  __nesc_hton_leuint16(TreeP$local.seed.data, TOS_NODE_ID);
  __nesc_hton_leuint8(TreeP$local.hopcount.data, INVALID_VALUE);
  __nesc_hton_leuint8(TreeP$local.children.data, 0);


  TreeP$SchedulerInit$init();

  TreeP$TDMASchedule$clearTableEntry(INVALID_VALUE, 0);

  for (i = 0; i < NBR_TABLE_SIZE; i++) {
      TreeP$nbrTable[i].flag = INVALID_VALUE;
      TreeP$nbrTable[i].missed = 0;
      TreeP$nbrTable[i].parent_id = INVALID_VALUE;
      TreeP$nbrTable[i].timestamp = 0;
      TreeP$nbrTable[i].retries = 0;
      TreeP$nbrTable[i].rounds = INVALID_VALUE;
      memset(& TreeP$nbrTable[i].beacon, 0, sizeof(dozer_beacon_t ));
      __nesc_hton_leuint8(TreeP$nbrTable[i].beacon.hopcount.data, INVALID_VALUE);
    }
  ...
  if (TOS_NODE_ID == ROOT_MOTE_ID) {
      __nesc_hton_leuint8(TreeP$local.hopcount.data, 0);
      TreeP$TreeConnected = TRUE;
      TreeP$ParentOn = TRUE;
      TreeP$send_beacon$postTask();
    }
...
# 54 "/opt/CVSTinyOS/tinyos-2.x/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$0$Interrupts$rxDone(uint8_t arg_0x40ce5758, uint8_t data){
#line 54
  switch (arg_0x40ce5758) {
#line 54
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C$0$CLIENT_ID:
#line 54
...
#line 54
    default:
#line 54
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$0$Interrupts$default$rxDone(arg_0x40ce5758, data);
#line 54
      break;
#line 54
    }
...
# 39 "/opt/CVSTinyOS/tinyos-2.x/tos/chips/msp430/usart/HplMsp430I2CInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$0$I2CInterrupts$fired(uint8_t arg_0x40ce4010){
#line 39
    /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$0$I2CInterrupts$default$fired(arg_0x40ce4010);
#line 39
}
#line 39
...
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$0$Interrupts$txDone(uint8_t arg_0x40ce5758){
#line 49
  switch (arg_0x40ce5758) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C$0$CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$0$Interrupts$default$txDone(arg_0x40ce5758);
#line 49
      break;
#line 49
    }
...
# 28 "/opt/CVSTinyOS/tinyos-2.x/tos/chips/msp430/timer/Msp430TimerEvent.nc"
static void /*Msp430TimerC.Msp430TimerB*/Msp430TimerP$1$Event$fired(uint8_t arg_0x406494f0){
#line 28
  switch (arg_0x406494f0) {
#line 28
    case 0:
...
#line 28
    default:
#line 28
      /*Msp430TimerC.Msp430TimerB*/Msp430TimerP$1$Event$default$fired(arg_0x406494f0);
#line 28
      break;
#line 28
    }
...
#line 533
{
  ...
  switch (__nesc_ntoh_leuint8(dmsg->type.data)) {
      ...
      if (__nesc_ntoh_leuint8(TreeP$local.children.data) < MAX_CHILDREN) {
          TreeP$ConnReqListenTimer$startOneShot(ACTIVATION_WAIT_PERIOD);
        }
...
#line 119
        {
          TreeP$SeedInit$init(__nesc_ntoh_leuint16(TreeP$local.seed.data));
          __nesc_hton_leuint16(TreeP$local.seed.data, TreeP$Random$rand16() & 0x1ff);
        }
#line 122
        __nesc_atomic_end(__nesc_atomic); }
      TreeP$BeaconTimer$startOneShot(TreeP$beacon_interval + __nesc_ntoh_leuint16(TreeP$local.seed.data));
    }
  else {
...
#line 139
{
  if ((((!TreeP$radioOn || TreeP$sendBusy) || TreeP$ParentOn) || TreeP$ChildOn) || !TreeP$TreeConnected) {
#line 140
      return;
    }
#line 141
  ...
  switch (type) 
    {
      ...
      for (i = 0; i < NBR_TABLE_SIZE; i++) {
          if (TreeP$nbrTable[i].parent_id == TreeP$listen_id) {
              rounds = TreeP$nbrTable[i].rounds;
              break;
            }
        }
      ...
      TreeP$BeaconWaitTimer$startOneShot(2 * rounds * (TreeP$nbrTable[i].missed + 1) * CLOCK_DRIFT_COMPENSATION + 1);
      break;
...
#line 165
  ...
  if (!boolean) {
      ...
      xFreqUsage = __nesc_ntoh_leuint8(nx->beacon.hopcount.data);
      yFreqUsage = __nesc_ntoh_leuint8(ny->beacon.hopcount.data);
    }
...
#line 307
  for (i = 0; i < MAX_POTENTIAL_PARENTS; i++) {
      if (SchedulerP$ParentNodes[i] != (void *)0) {
...
#line 248
  ...
  rounds = SchedulerP$ParentNodes[parent_index]->rounds;

  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 262
    {
      tmp = rounds * (SchedulerP$ParentNodes[parent_index]->missed + 1);
      seed_val = __nesc_ntoh_leuint16(SchedulerP$ParentNodes[parent_index]->beacon.seed.data);
...
#line 271
  ...
  next_beacon_period = (DEFAULT_BEACON_INTERVAL - CLOCK_DRIFT_COMPENSATION) * rounds * (SchedulerP$ParentNodes[parent_index]->missed + 1) + seed_sum;
  ...
  if (! SchedulerP$ParentNodes[parent_index]->missed && SchedulerP$ParentNodes[parent_index]->parent_id == SchedulerP$gParentNode.parent_id) {
      memcpy(&SchedulerP$gParentNode, SchedulerP$ParentNodes[parent_index], sizeof(dozer_parent_t ));
      { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 299
...
#line 365
  ...
  if (adr->flag == INVALID_VALUE) {
      ...
      for (i = 0; i < NBR_TABLE_SIZE; i++) {
          if (adr->parent_id == TreeP$nbrTable[i].parent_id) {
              TreeP$gParent_id = TreeP$nbrTable[i].parent_id;
              TreeP$gPIndex = i;
              break;
            }
        }
...
#line 219
                { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 219
                  __nesc_hton_leuint16(SchedulerP$ChildNodes[i].child_id.data, INVALID_VALUE);
#line 219
                  __nesc_atomic_end(__nesc_atomic); }
              }
#line 220
...
static error_t SchedulerP$TDMASchedule$setParentTimeStamp(uint16_t node_id, dozer_beacon_t *bmsg, uint32_t timestamp)
{
  ...
  for (i = 0; i < MAX_POTENTIAL_PARENTS; i++) {
      if (SchedulerP$ParentNodes[i] != (void *)0 && SchedulerP$ParentNodes[i]->parent_id == node_id) {

          SchedulerP$ParentNodes[i]->parent_id = node_id;
          if (bmsg != (void *)0) {
              memcpy(& SchedulerP$ParentNodes[i]->beacon, bmsg, sizeof(dozer_beacon_t ));
              SchedulerP$ParentNodes[i]->timestamp = timestamp;
              SchedulerP$ParentNodes[i]->missed = 0;
            }
          else 
#line 337
            {
              SchedulerP$ParentNodes[i]->missed++;
              if (SchedulerP$ParentNodes[i]->missed >= MAX_CONSECUTIVE_MISSED_BEACONS) {
                  SchedulerP$Leds$led1Toggle();
                  SchedulerP$TDMASchedule$clearTableEntry(SchedulerP$ParentNodes[i]->parent_id, 1);
                  if (node_id == SchedulerP$gParentNode.parent_id) {
#line 342
                      SchedulerP$chooseParent();
                    }
#line 343
                  break;
                }
