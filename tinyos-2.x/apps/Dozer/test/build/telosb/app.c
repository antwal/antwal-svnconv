...
static void TreeP$DataSend$sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static void TreeP$send_data$runTask(void );
# 72 "/opt/CVSTinyOS/tinyos-2.x/tos/lib/timer/Timer.nc"
...
uint8_t len);
#line 112
static uint8_t /*DozerC.BeaconSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$maxPayloadLength(void );
# 89 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Send.nc"
...
# 69 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/AMSend.nc"
static error_t /*DozerC.DataSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$send(am_addr_t addr, 
#line 60
message_t * msg, 
...
/*DozerC.DataSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
#line 112
static uint8_t /*DozerC.DataSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$maxPayloadLength(void );
# 89 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Send.nc"
static void /*DozerC.DataSenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$sendDone(
#line 85
message_t * msg, 
...
#line 7
static error_t SchedulerP$TDMASchedule$setParentTimeStamp(uint16_t node_id, bool parent, uint16_t seed, uint32_t timestamp);
#line 5
...
# 69 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/AMSend.nc"
static error_t TreeP$DataSend$send(am_addr_t addr, 
#line 60
message_t * msg, 
...
uint8_t len);
#line 112
static uint8_t TreeP$DataSend$maxPayloadLength(void );
# 56 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
uint8_t len);
#line 112
static uint8_t TreeP$BeaconSend$maxPayloadLength(void );
# 56 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static error_t TreeP$send_data$postTask(void );
# 62 "/opt/CVSTinyOS/tinyos-2.x/tos/lib/timer/Timer.nc"
...
#line 7
static error_t TreeP$TDMASchedule$setParentTimeStamp(uint16_t node_id, bool parent, uint16_t seed, uint32_t timestamp);
#line 5
...
#line 117
typedef int TreeP$__nesc_sillytask_send_data[TreeP$send_data];
#line 26
...
static inline void TreeP$startTimer(void );
...
static inline void TreeP$send_data$runTask(void );
#line 131
static void TreeP$TDMASchedule$radioWakeup(uint8_t type, uint16_t node_id);
#line 166
...
#line 259
static inline message_t *TreeP$DataReceive$receive(message_t *msg, void *payload, uint8_t len);
...
static void TreeP$DataSend$sendDone(message_t *msg, error_t error);
# 64 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Send.nc"
...
uint8_t len);
#line 101
static uint8_t /*DozerC.BeaconSenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$maxPayloadLength(void );
...
static inline error_t /*DozerC.BeaconSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline uint8_t /*DozerC.BeaconSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$maxPayloadLength(void );
...
# 99 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/AMSend.nc"
static void /*DozerC.DataSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Send.nc"
static error_t /*DozerC.DataSenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$send(
#line 56
message_t * msg, 
...
/*DozerC.DataSenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$getPayload(
#line 111
message_t * msg, 
...
uint8_t len);
#line 101
static uint8_t /*DozerC.DataSenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$maxPayloadLength(void );
# 92 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/AMPacket.nc"
static void /*DozerC.DataSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setDestination(
#line 88
message_t * amsg, 
...
am_addr_t addr);
#line 151
static void /*DozerC.DataSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setType(
#line 147
message_t * amsg, 
...
am_id_t t);
# 45 "/opt/CVSTinyOS/tinyos-2.x/tos/system/AMQueueEntryP.nc"
static inline error_t /*DozerC.DataSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*DozerC.DataSenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$sendDone(message_t *m, error_t err);



static inline uint8_t /*DozerC.DataSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$maxPayloadLength(void );



static inline void */*DozerC.DataSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$getPayload(message_t *m, uint8_t len);
# 118 "/opt/CVSTinyOS/tinyos-2.x/tos/lib/timer/Timer.nc"
...
# 23 "SchedulerP.nc"
dozer_parent_schedule_t SchedulerP$ParentNodes[MAX_POTENTIAL_PARENTS];
...
static inline error_t SchedulerP$TDMASchedule$clearTableEntry(uint16_t node_id, uint8_t parent);
#line 75
static inline void SchedulerP$startBeaconListenTimer(uint8_t parent_index);
#line 126
static error_t SchedulerP$TDMASchedule$setParentTimeStamp(uint16_t node_id, bool parent, uint16_t parent_seed, uint32_t timestamp);
#line 149
...
# 28 "/opt/CVSTinyOS/tinyos-2.x/tos/chips/msp430/timer/Msp430TimerEvent.nc"
inline static void /*Msp430TimerC.Msp430TimerA*/Msp430TimerP$0$Event$fired(uint8_t arg_0x40622788){
#line 28
  switch (arg_0x40622788) {
#line 28
    case 0:
#line 28
...
#line 28
    default:
#line 28
      /*Msp430TimerC.Msp430TimerA*/Msp430TimerP$0$Event$default$fired(arg_0x40622788);
#line 28
      break;
#line 28
    }
...
# 118 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Resource.nc"
inline static bool /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$isOwner(uint8_t arg_0x40b9b718){
#line 118
  unsigned char __nesc_result;
#line 118

#line 118
  switch (arg_0x40b9b718) {
#line 118
...
#line 118
    default:
#line 118
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$default$isOwner(arg_0x40b9b718);
#line 118
      break;
#line 118
    }
...
# 39 "/opt/CVSTinyOS/tinyos-2.x/tos/chips/msp430/usart/Msp430SpiConfigure.nc"
inline static msp430_spi_union_config_t */*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$Msp430SpiConfigure$getConfig(uint8_t arg_0x40b9a1b8){
#line 39
  union __nesc_unnamed4282 *__nesc_result;
#line 39

#line 39
    __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$Msp430SpiConfigure$default$getConfig(arg_0x40b9a1b8);
#line 39
...
# 49 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceConfigure$configure(uint8_t arg_0x40cb9510){
#line 49
  switch (arg_0x40cb9510) {
#line 49
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceConfigure$default$configure(arg_0x40cb9510);
#line 49
      break;
#line 49
    }
...
# 51 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceRequested$immediateRequested(uint8_t arg_0x40cba108){
#line 51
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceRequested$default$immediateRequested(arg_0x40cba108);
#line 51
}
#line 51
...
# 87 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$immediateRequest(uint8_t arg_0x40b9b718){
#line 87
  unsigned char __nesc_result;
#line 87
...
#line 87
    default:
#line 87
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$default$immediateRequest(arg_0x40b9b718);
#line 87
      break;
#line 87
    }
...
# 43 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceRequested$requested(uint8_t arg_0x40cba108){
#line 43
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceRequested$default$requested(arg_0x40cba108);
#line 43
}
#line 43
...
# 78 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$request(uint8_t arg_0x40b9b718){
#line 78
  unsigned char __nesc_result;
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$default$request(arg_0x40b9b718);
#line 78
      break;
#line 78
    }
...
# 55 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceConfigure$unconfigure(uint8_t arg_0x40cb9510){
#line 55
  switch (arg_0x40cb9510) {
#line 55
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C$0$CLIENT_ID:
...
#line 55
    default:
#line 55
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceConfigure$default$unconfigure(arg_0x40cb9510);
#line 55
      break;
#line 55
    }
...
# 110 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$release(uint8_t arg_0x40b9b718){
#line 110
  unsigned char __nesc_result;
#line 110
...
#line 110
    default:
#line 110
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$default$release(arg_0x40b9b718);
#line 110
      break;
#line 110
    }
...
# 99 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void /*DozerC.DataSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$sendDone(message_t * msg, error_t error){
#line 99
  TreeP$DataSend$sendDone(msg, error);
#line 99
}
#line 99
# 57 "/opt/CVSTinyOS/tinyos-2.x/tos/system/AMQueueEntryP.nc"
...
#line 57
{
  /*DozerC.DataSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$sendDone(m, err);
}
...
# 89 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x40fd6010, message_t * msg, error_t error){
#line 89
  switch (arg_0x40fd6010) {
#line 89
    case 0U:
#line 89
...
#line 89
    case 1U:
#line 89
      /*DozerC.DataSenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$sendDone(msg, error);
#line 89
      break;
#line 89
    default:
#line 89
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x40fd6010, msg, error);
#line 89
      break;
#line 89
    }
...
#line 184
    __nesc_atomic_end(__nesc_atomic); }
  SchedulerP$TDMAScheduleTimer$startOneShotAt(timestamp, CHILD_CONNECTION_PERIOD);
}
...
#line 56
# 69 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x40fd69f8, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = CC2420ActiveMessageP$AMSend$send(arg_0x40fd69f8, addr, msg, len);
#line 69
...
# 59 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/SendNotifier.nc"
inline static void CC2420ActiveMessageP$SendNotifier$aboutToSend(am_id_t arg_0x40787b78, am_addr_t dest, message_t * msg){
#line 59
    CC2420ActiveMessageP$SendNotifier$default$aboutToSend(arg_0x40787b78, dest, msg);
#line 59
}
#line 59
...
# 95 "/opt/CVSTinyOS/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP$RadioBackoff$requestCca(am_id_t arg_0x40786230, message_t * msg){
#line 95
    CC2420ActiveMessageP$RadioBackoff$default$requestCca(arg_0x40786230, msg);
#line 95
}
#line 95
...
#line 50
# 7 "TDMASchedule.nc"
inline static error_t TreeP$TDMASchedule$setParentTimeStamp(uint16_t node_id, bool parent, uint16_t seed, uint32_t timestamp){
#line 7
  unsigned char __nesc_result;
#line 7

#line 7
  __nesc_result = SchedulerP$TDMASchedule$setParentTimeStamp(node_id, parent, seed, timestamp);
#line 7
...
#line 190
  if (TreeP$listen_id == TreeP$gParent_id) {
      TreeP$TDMASchedule$setParentTimeStamp(TreeP$listen_id, TRUE, INVALID_VALUE, TreeP$LocalTime$get());
    }
  else {
#line 193
    TreeP$TDMASchedule$setParentTimeStamp(TreeP$listen_id, FALSE, INVALID_VALUE, TreeP$LocalTime$get());
    }
}
...
#line 178
{
  SchedulerP$TDMASchedule$radioWakeup(TSLOT_DATA_SEND, SchedulerP$ParentNodes[0].seed);
}
...
# 72 "/opt/CVSTinyOS/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x40ecf068){
#line 72
  switch (arg_0x40ecf068) {
#line 72
    case 1U:
#line 72
...
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x40ecf068);
#line 72
      break;
#line 72
    }
...
#line 118
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startOneShotAt(6U, t0, dt);
#line 118
}
#line 118
inline static void SchedulerP$PPBListenTimer1$startOneShotAt(uint32_t t0, uint32_t dt){
#line 118
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startOneShotAt(5U, t0, dt);
#line 118
}
#line 118
inline static void SchedulerP$PPBListenTimer0$startOneShotAt(uint32_t t0, uint32_t dt){
#line 118
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startOneShotAt(4U, t0, dt);
#line 118
}
#line 118
# 41 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Random.nc"
...
#line 79
  ...
  if (! SchedulerP$ParentNodes[parent_index].parent) {
      rounds = PARENTS_UPDATE_INTERVAL / DEFAULT_BEACON_INTERVAL;
    }

  tmp = rounds;
  seed_val = SchedulerP$ParentNodes[parent_index].seed;
  while (tmp--) {
  ...
  SchedulerP$ParentNodes[parent_index].seed = seed_val;
...
# 67 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * CC2420TinyosNetworkP$NonTinyosReceive$receive(uint8_t arg_0x40f84bb8, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = CC2420TinyosNetworkP$NonTinyosReceive$default$receive(arg_0x40f84bb8, msg, payload, len);
#line 67
...
# 67 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP$Snoop$receive(am_id_t arg_0x40788148, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = CC2420ActiveMessageP$Snoop$default$receive(arg_0x40788148, msg, payload, len);
#line 67
...
inline static void * /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$getPayload(am_id_t arg_0x40fd69f8, message_t * msg, uint8_t len){
#line 124
  void *__nesc_result;
#line 124

#line 124
  __nesc_result = CC2420ActiveMessageP$AMSend$getPayload(arg_0x40fd69f8, msg, len);
#line 124
...
#line 216
{
  dozer_beacon_t *bmsg = TreeP$BeaconSend$getPayload(msg, sizeof(dozer_beacon_t ));
  uint16_t src = TreeP$AMPacket$source(msg);

  TreeP$BeaconWaitTimer$stop();
  TreeP$report_received();

  TreeP$seed = bmsg->seed;
  TreeP$stop_radio();
  if (TreeP$TreeConnected) {

      if (src == TreeP$gParent_id) {
          TreeP$TDMASchedule$setParentTimeStamp(src, TRUE, TreeP$seed, TreeP$LocalTime$get());
        }
      else {
#line 230
        TreeP$TDMASchedule$setParentTimeStamp(src, FALSE, TreeP$seed, TreeP$LocalTime$get());
        }
    }
  else 
#line 231
...
# 67 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP$Receive$receive(am_id_t arg_0x40789a60, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x40789a60) {
#line 67
    case 51:
#line 67
      __nesc_result = TreeP$DataReceive$receive(msg, payload, len);
#line 67
      break;
#line 67
    case 153:
...
#line 67
    default:
#line 67
      __nesc_result = CC2420ActiveMessageP$Receive$default$receive(arg_0x40789a60, msg, payload, len);
#line 67
      break;
#line 67
    }
...
# 92 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$Resource$granted(uint8_t arg_0x40ba18e8){
#line 92
  switch (arg_0x40ba18e8) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C$0$CLIENT_ID:
#line 92
...
#line 92
    default:
#line 92
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$Resource$default$granted(arg_0x40ba18e8);
#line 92
      break;
#line 92
    }
...
# 92 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$Resource$granted(uint8_t arg_0x40cbb6b8){
#line 92
  switch (arg_0x40cbb6b8) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C$0$CLIENT_ID:
#line 92
...
#line 92
    default:
#line 92
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$Resource$default$granted(arg_0x40cbb6b8);
#line 92
      break;
#line 92
    }
...
# 71 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/SpiPacket.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$SpiPacket$sendDone(uint8_t arg_0x40b9dee8, uint8_t * txBuf, uint8_t * rxBuf, uint16_t len, error_t error){
#line 71
  switch (arg_0x40b9dee8) {
#line 71
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C$0$CLIENT_ID:
#line 71
...
#line 71
    default:
#line 71
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$SpiPacket$default$sendDone(arg_0x40b9dee8, txBuf, rxBuf, len, error);
#line 71
      break;
#line 71
    }
...
# 71 "/opt/CVSTinyOS/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP$Fifo$readDone(uint8_t arg_0x40b17280, uint8_t * data, uint8_t length, error_t error){
#line 71
  switch (arg_0x40b17280) {
#line 71
    case CC2420_TXFIFO:
#line 71
...
#line 71
    default:
#line 71
      CC2420SpiP$Fifo$default$readDone(arg_0x40b17280, data, length, error);
#line 71
      break;
#line 71
    }
...
# 91 "/opt/CVSTinyOS/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP$Fifo$writeDone(uint8_t arg_0x40b17280, uint8_t * data, uint8_t length, error_t error){
#line 91
  switch (arg_0x40b17280) {
#line 91
    case CC2420_TXFIFO:
...
#line 91
    default:
#line 91
      CC2420SpiP$Fifo$default$writeDone(arg_0x40b17280, data, length, error);
#line 91
      break;
#line 91
    }
...
# 92 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void CC2420SpiP$Resource$granted(uint8_t arg_0x40b19818){
#line 92
  switch (arg_0x40b19818) {
#line 92
...
#line 92
    default:
#line 92
      CC2420SpiP$Resource$default$granted(arg_0x40b19818);
#line 92
      break;
#line 92
    }
...
# 99 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP$AMSend$sendDone(am_id_t arg_0x407890a0, message_t * msg, error_t error){
#line 99
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x407890a0, msg, error);
#line 99
}
#line 99
...
# 56 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/TaskBasic.nc"
inline static error_t TreeP$send_data$postTask(void ){
#line 56
  unsigned char __nesc_result;
#line 56

#line 56
  __nesc_result = SchedulerBasicP$TaskBasic$postTask(TreeP$send_data);
#line 56
...
#line 56
# 64 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Send.nc"
inline static error_t /*DozerC.DataSenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$send(message_t * msg, uint8_t len){
#line 64
  unsigned char __nesc_result;
#line 64
...
inline static void /*DozerC.DataSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setType(message_t * amsg, am_id_t t){
#line 151
...
#line 151
#line 92
inline static void /*DozerC.DataSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 92
...
#line 47
{
  /*DozerC.DataSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setDestination(msg, dest);
  /*DozerC.DataSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setType(msg, 51);
  return /*DozerC.DataSenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$send(msg, len);
}

# 69 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t TreeP$DataSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = /*DozerC.DataSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$send(addr, msg, len);
#line 69
...
#line 69
# 114 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Send.nc"
inline static void * /*DozerC.DataSenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$getPayload(message_t * msg, uint8_t len){
#line 114
  void *__nesc_result;
#line 114
...
#line 65
{
  return /*DozerC.DataSenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$getPayload(m, len);
}

# 124 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void * TreeP$DataSend$getPayload(message_t * msg, uint8_t len){
#line 124
  void *__nesc_result;
#line 124

#line 124
  __nesc_result = /*DozerC.DataSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$getPayload(msg, len);
#line 124
...
inline static uint8_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$maxPayloadLength(am_id_t arg_0x40fd69f8){
#line 112
  unsigned char __nesc_result;
#line 112

#line 112
  __nesc_result = CC2420ActiveMessageP$AMSend$maxPayloadLength(arg_0x40fd69f8);
#line 112
...
inline static uint8_t /*DozerC.DataSenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$maxPayloadLength(void ){
#line 101
  unsigned char __nesc_result;
#line 101
...
#line 61
{
  return /*DozerC.DataSenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$maxPayloadLength();
}

# 112 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static uint8_t TreeP$DataSend$maxPayloadLength(void ){
#line 112
  unsigned char __nesc_result;
#line 112

#line 112
  __nesc_result = /*DozerC.DataSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$maxPayloadLength();
#line 112
...
#line 117
{
  if (TreeP$radioOn && !TreeP$sendBusy && sizeof TreeP$local <= TreeP$DataSend$maxPayloadLength()) 
    {


      memcpy(TreeP$DataSend$getPayload(&TreeP$sendBuf, sizeof TreeP$local), &TreeP$local, sizeof TreeP$local);
      if (TreeP$DataSend$send(TreeP$gParent_id, &TreeP$sendBuf, sizeof TreeP$local) == SUCCESS) {
        TreeP$sendBusy = TRUE;
        }
    }
  else 
...
#line 47
{
  ...
  /*DozerC.BeaconSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 153);
...
#line 69
# 101 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/Send.nc"
inline static uint8_t /*DozerC.BeaconSenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$maxPayloadLength(void ){
#line 101
  unsigned char __nesc_result;
#line 101
...
#line 61
{
  return /*DozerC.BeaconSenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$maxPayloadLength();
}

# 112 "/opt/CVSTinyOS/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static uint8_t TreeP$BeaconSend$maxPayloadLength(void ){
#line 112
  unsigned char __nesc_result;
#line 112

#line 112
  __nesc_result = /*DozerC.BeaconSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$maxPayloadLength();
#line 112
...
#line 202
{
  if (TreeP$radioOn && !TreeP$sendBusy && sizeof TreeP$local <= TreeP$BeaconSend$maxPayloadLength()) 
    {


      memcpy(TreeP$BeaconSend$getPayload(&TreeP$sendBuf, sizeof TreeP$local), &TreeP$local, sizeof TreeP$local);
      if (TreeP$BeaconSend$send(AM_BROADCAST_ADDR, &TreeP$sendBuf, sizeof TreeP$local) == SUCCESS) {
        TreeP$sendBusy = TRUE;
        }
    }
  else 
...
#line 36
                SchedulerP$ParentNodes[i].parent_id = INVALID_VALUE;
              }
#line 37
            return SUCCESS;
          }
...
#line 50
{
  ...
  TreeP$local.seed = DEFAULT_SEED_VALUE;
  ...
  if (TOS_NODE_ID == ROOT_MOTE_ID) {
      ...
      TreeP$send_beacon$postTask();
      TreeP$TDMASchedule$allocChildTimeSlot(2);
      TreeP$TDMASchedule$allocChildTimeSlot(1);
    }
  else 
#line 75
    {
      if (TOS_NODE_ID == 1) {
        TreeP$TDMASchedule$setParentTDMASlot(1);
        }
      if (TOS_NODE_ID == 2) {
        TreeP$TDMASchedule$setParentTDMASlot(0);
        }
    }
}
...
# 54 "/opt/CVSTinyOS/tinyos-2.x/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$0$Interrupts$rxDone(uint8_t arg_0x40c86758, uint8_t data){
#line 54
  switch (arg_0x40c86758) {
#line 54
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C$0$CLIENT_ID:
#line 54
...
#line 54
    default:
#line 54
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$0$Interrupts$default$rxDone(arg_0x40c86758, data);
#line 54
      break;
#line 54
    }
...
# 39 "/opt/CVSTinyOS/tinyos-2.x/tos/chips/msp430/usart/HplMsp430I2CInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$0$I2CInterrupts$fired(uint8_t arg_0x40c85010){
#line 39
    /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$0$I2CInterrupts$default$fired(arg_0x40c85010);
#line 39
}
#line 39
...
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$0$Interrupts$txDone(uint8_t arg_0x40c86758){
#line 49
  switch (arg_0x40c86758) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C$0$CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$0$Interrupts$default$txDone(arg_0x40c86758);
#line 49
      break;
#line 49
    }
...
# 28 "/opt/CVSTinyOS/tinyos-2.x/tos/chips/msp430/timer/Msp430TimerEvent.nc"
static void /*Msp430TimerC.Msp430TimerB*/Msp430TimerP$1$Event$fired(uint8_t arg_0x40622788){
#line 28
  switch (arg_0x40622788) {
#line 28
    case 0:
...
#line 28
    default:
#line 28
      /*Msp430TimerC.Msp430TimerB*/Msp430TimerP$1$Event$default$fired(arg_0x40622788);
#line 28
      break;
#line 28
    }
...
#line 64
      break;
#line 64
    case TreeP$send_data:
#line 64
      TreeP$send_data$runTask();
#line 64
      break;
#line 64
  ...
  switch (type) 
    {
      ...
      case TSLOT_LISTEN: 
        TreeP$BeaconWaitTimer$startOneShot(TDMA_SLOT_LEN / 2);
      break;
...
#line 134
              SchedulerP$ParentNodes[i].seed = parent_seed;
            }
#line 135
          SchedulerP$ParentNodes[i].parent = parent;
