...
public class TestFtspMsg extends net.tinyos.message.Message {
    ...
    /**
     * Return the value (as a long) of the field 'skew_times_1000000'
     */
    public long get_skew_times_1000000() {
        return (long)getUIntBEElement(offsetBits_skew_times_1000000(), 32);
    }

    /**
     * Set the value of the field 'skew_times_1000000'
     */
    public void set_skew_times_1000000(long value) {
        setUIntBEElement(offsetBits_skew_times_1000000(), 32, value);
    }
