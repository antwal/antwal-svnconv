...
// Appication Top level Configuration
#include "data.h"                                               // Includes Data Packet structures & Macro definitions
...
implementation
{
	components MainC,			// TinyOS Main Component
		   ...
		   StaticRouter as MultiHopM,
		   new TimerMilliC() as MyTimerC;	// Component for MultiHop Routing
