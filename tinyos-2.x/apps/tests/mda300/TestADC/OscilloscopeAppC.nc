...
implementation
{
  components OscilloscopeC, MainC, ActiveMessageC, LedsC,
    new TimerMilliC(), new MDA300IBADCC() as Sensor,
  ...
  OscilloscopeC.SensorControl -> Sensor;
  OscilloscopeC.Read1 -> Sensor.ADConvert[6];
  OscilloscopeC.SetParam1 -> Sensor.SetParam[6];
