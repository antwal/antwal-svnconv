...
implementation
{
  ...
  event void Boot.booted() {
    ...
    param = EXITATION_25 | AVERAGE_EIGHT;//AVERAGE_SIXTEEN;//SAMPLER_DEFAULT | EXITATION_33 | DELAY_BEFORE_MEASUREMENT;
  ...
  event void SensorControl.startDone(error_t error) {
    if (call SetParam1.setParam(param) != SUCCESS)
      report_problem();
  ...
  */
  ...
  event void Read1.readDone(uint16_t data) {
