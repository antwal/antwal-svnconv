...
implementation
{
  components OscilloscopeC, MainC, ActiveMessageC, LedsC,
    new TimerMilliC(),new AMSenderC(AM_OSCILLOSCOPE),
    new AFWA_AESC(AM_OSCILLOSCOPE), 
  ...
  // Turn-On AES security
  OscilloscopeC.RadioControl -> AFWA_AESC.SplitControl; 
  // AES Security Interface
  OscilloscopeC.AFWA_AESI -> AFWA_AESC;
